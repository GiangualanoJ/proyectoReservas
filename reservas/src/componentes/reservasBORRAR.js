    ...
    const renderHeader = () => {
        ...
        return (
            <React.Fragment>
                ...
                <span className="ml-2 p-input-icon-left">
            ...
            <div className='grid justify-content-center align-items-center p-0 m-0'>
                {reservas &&
                    reservas.map((reserva) => (
                        <div className='col-5' key={reserva.id}>
                            <div className='card'>
                ...
                <Dialog visible={DialogRE} style={{ width: '32rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Salon Details" modal className="p-fluid" onHide={hideDialog}>
